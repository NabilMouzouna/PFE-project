...
| [ADR-007 — SDK Package Distribution](./adr/ADR-007-sdk-package-distribution.md) | Public **npm** as default registry for `@appbase/sdk` (+ types); GitHub Packages not default | External developer installs; complements [TICKET-012](../tasks/TICKET-012-sdk-npm-publish-readiness.md) |
